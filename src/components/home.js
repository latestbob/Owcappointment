                    ...
                    <div class="row">
                                            {times && times.map((row, index) => {
                                                ...
                                                if(moment(selectedDate).format('dddd, MMMM DD, YYYY') == "Thursday, February 02, 2023"){
                                                    ...
                                                    if(row.label == "9:00 am" || row.label == "9:30 am" || row.label == "10:00 am" ||row.label == "10:30 am" ||row.label == "11:00 am" || row.label == "11:30 am" || row.label == "3:00 pm" || row.label == "3:30 pm" || row.label == "4:00 pm" || row.label == "4:30 pm" || row.label == "5:00 pm" || row.label == "12:00 pm"){
                                                        row.match = true;
                                                    }
                                                }

                                                else if(moment(selectedDate).format('dddd, MMMM DD, YYYY') == "Tuesday, February 07, 2023"){
                                                    if(row.label == "9:00 am" || row.label == "9:30 am" || row.label == "10:00 am" || row.label == "10:30 am" || row.label == "11:00 am" || row.label == "11:30 am" || row.label == "12:00 pm" || row.label == "12:30 pm" || row.label == "1:00 pm" || row.label == "4:30 pm" || row.label == "3:00 pm" || row.label == "3:30 pm" || row.label == "4:00 pm" || row.label == "5:00 pm")  {
                                                        row.match = true;
                                                    }
                                                }
                                                    ...
                                                    if(row.label == "10:00 am" || row.label == "3:00 pm"){
                                                        row.match = true;
                                                    }
                                                }
